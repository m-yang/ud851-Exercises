...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadMultiplier(sharedPreferences);
    ...
    private void loadMultiplier(SharedPreferences sharedPreferences) {
        String multiplier = sharedPreferences.getString(getString(R.string.pref_multiplier_key),
                getString(R.string.pref_multiplier_default));
        mVisualizerView.setMinSizeScale(Float.valueOf(multiplier));
