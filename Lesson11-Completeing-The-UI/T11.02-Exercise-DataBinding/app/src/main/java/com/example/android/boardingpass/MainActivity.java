...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        //set terminal, gate seat information in table
        ...
        String boardingTime = dateFormatter.format(info.boardingTime);
        String departureTime = dateFormatter.format(info.departureTime);
        String arrivalTime = dateFormatter.format(info.arrivalTime);
        ...
        long minutes = minutesUntilBoarding - TimeUnit.HOURS.toMinutes(hoursUntilBoarding);
        String hoursAndMinutesUntilBoarding = getString(R.string.countDownFormat, hoursUntilBoarding, minutes);
